...
half3 GlobalIllumination(BRDFData brdfData, BRDFData brdfDataClearCoat, float clearCoatMask,
    half3 bakedGI, half occlusion,half RO, float3 positionWS,
    half3 normalWS, half3 viewDirectionWS, float2 normalizedScreenSpaceUV,float4 SSR)
{
...
{
    return GlobalIllumination(brdfData, brdfDataClearCoat, clearCoatMask, bakedGI, occlusion,1, positionWS, normalWS, viewDirectionWS, float2(0.0f, 0.0f));
}
#endif
...
half3 GlobalIllumination(BRDFData brdfData, half3 bakedGI, half occlusion, float3 positionWS, half3 normalWS, half3 viewDirectionWS)
{
    ...
    return GlobalIllumination(brdfData, noClearCoat, 0.0, bakedGI, occlusion,1, positionWS, normalWS, viewDirectionWS, 0);
}
